//
//  MediaInteractiveTransitioning.swift
//  DJIFileManager
//
...
class MediaInteractiveTransitioning: NSObject, UIViewControllerInteractiveTransitioning {
...
extension MediaInteractiveTransitioning {
    func handlePanWithPanGestureRecognizer(_ gestureRecognizer: UIPanGestureRecognizer, viewToPan: UIView, anchorPoint: CGPoint) {
        ...
        let scaleValue = backgroundAlpha < 0.4 ? 0.4 : backgroundAlpha
        scaleTransForm = scaleTransForm.scaledBy(x: scaleValue, y: scaleValue)
    ...
    func finishPanWithPanGestureRecognizer(_ gestureRecognizer: UIPanGestureRecognizer, verticalDelta: CGFloat, viewToPan: UIView, anchorPoint: CGPoint) {
        ...
        let panDismissDistanceRatio = 50.0 / 667.0
